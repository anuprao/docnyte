	...
	def run(self,lines):
		...
		for line in lines:
			...
			if None==m_start and None==m_end :
				...
				if m_start:
					print "start ..."
					new_lines.append('<div markdown="1" class="divfooter">')
...
class MyFloatRight(markdown.Extension):
    def extendMarkdown(self, md, md_globals):
		...
		pattern_start = re.compile(r'(--)(footer-start)--')
		pattern_end = re.compile(r'(--)(footer-end)--')
		
		md.preprocessors.add('footer', MyPreprocessor(md), "_begin")        
